		...
		<tr>
			...
			<td valign="top" align="center">
				...
				<table id="board_write_tbl">
					...
					<tr>
						...
						<td colspan="5" style="width:65%">
							<span style="font-size:12px;">안녕하세요 반갑습니다</span>
						</td>
					</tr>
					...
					<tr>	
						...
						<td style="width:10%">
							<span style="font-size:12px;">하마</span>
						</td>
						<td id="title_header" style="width:10%">
				...
				<table id="board_write_func_tbl">
					<tr>
						<td>
							<a href="list.do" class="board_write_btn board_write_btn_font">목록</a>
						</td>
						<td>
							<a class="board_write_btn board_write_btn_font">답글</a>
						</td>
					</tr>
				</table>
				</div>
